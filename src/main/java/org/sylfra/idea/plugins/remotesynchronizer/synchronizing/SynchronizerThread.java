...
public class SynchronizerThread
{
  ...
  public SynchronizerThread(FileSyncPlugin plugin,
  ...
  public FileSyncPlugin getPlugin()
  {
    return plugin;
  }
  ...
  protected void finished()
  {
    ...
    if (statsInfo.hasFailures())
    {
      ...
      twManager.invokeLater(new Runnable()
      {
        public void run()
        {
          twManager.getToolWindow(FileSyncPlugin.PLUGIN_NAME).show(null);
        }
      });
    }
  }

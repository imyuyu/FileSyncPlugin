...
public class TargetTab extends JPanel
{
    ...
    int initialPos)
  {
    ...
    cbActive = new JBCheckBox(LabelsFactory.get(LabelsFactory.LB_ACTIVE),
  ...
  {
    JPanel pnActive = new JBPanel<>(new BorderLayout());
    pnActive.add(cbActive, BorderLayout.WEST);
    JLabel xInfo = new JBLabel("X : "
  ...
  {
    // Paths table
    JPanel pnTable = new JBPanel<>(new BorderLayout());
